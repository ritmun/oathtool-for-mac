...
2. Create a `token`(aka `key`) in your auth settings (e.g. okta, or your sso credentials settings page for your org.) Remember to choose `totp` token type, if asked.
