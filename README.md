...
2. Create a `token` in your auth settings (e.g. _token.redhat.com_, or the specifc sso settings page for your org.) Remember to choose `totp` token type, if asked.
